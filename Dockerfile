...
RUN MAX_JOBS=2 pip install https://github.com/mjun0812/flash-attention-prebuild-wheels/releases/download/v0.9.47/flash_attn-2.8.3+cu132torch2.13-cp312-cp312-linux_x86_64.whl --no-build-isolation --break-system-packages
